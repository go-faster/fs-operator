...
// FSBucketSpec defines the desired state of FSBucket
type FSBucketSpec struct {
	...
	// foo is an example field of FSBucket. Edit fsbucket_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// FSBucketStatus defines the observed state of FSBucket.
type FSBucketStatus struct {
	...
	// conditions represent the current state of the FSBucket resource.
