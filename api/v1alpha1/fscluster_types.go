...
// FSClusterSpec defines the desired state of FSCluster
type FSClusterSpec struct {
	...
	// foo is an example field of FSCluster. Edit fscluster_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// FSClusterStatus defines the observed state of FSCluster.
type FSClusterStatus struct {
	...
	// conditions represent the current state of the FSCluster resource.
