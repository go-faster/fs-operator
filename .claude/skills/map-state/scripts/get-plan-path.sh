#!/usr/bin/env bash
# MAP-MANAGED: {"generated_by":"mapify-cli","mapify_version":"3.23.0","template_hash":"65b855caa56f25430b51a550609f49b069f072244250f32ff20b1dc85c81932f","installed_at":"2026-07-24T00:36:20Z"}
# map:start
#
