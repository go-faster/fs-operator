#!/usr/bin/env bash
# MAP-MANAGED: {"generated_by":"mapify-cli","mapify_version":"3.23.0","template_hash":"cce696c9d3cedd42bfb264205796db9085da3cb0d9860967fe7f66b95a329867","installed_at":"2026-07-24T00:36:20Z"}
# map:start
#
