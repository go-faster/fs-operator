#!/usr/bin/env bash
# MAP-MANAGED: {"generated_by":"mapify-cli","mapify_version":"3.23.0","template_hash":"2506acc8613798f0462dd853bd23d6e56f527e13dc2802887086172dbba6ffd0","installed_at":"2026-07-24T00:36:20Z"}
# map:start
# =============================================================================
